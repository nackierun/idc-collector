                                        ...
                                        <div class="mb-3 col-md-4">
                                            <div class="card">
                                                ...
                                                <div class="card-body mw-50 mh-50">
                                                    @if ($photo)
                                                    <img src="{{ $photo->temporaryUrl() }}" alt="photo" class="card-img-top">
                                                    @else
                                                        <img src="{!! asset('avatar/blank-profile-picture-973460_640.png') !!}" alt="photo" class="card-img-top">
